...
Neuron is currently maintained on the latest `main` branch and the latest
npm release only.
...
If you believe you have found a security vulnerability in Neuron, please
report it privately.
...
- the Neuron source code in this repository
- official release artifacts published from this repository
- the `@gitlawb/neuron` npm package
