# Neuron Quick Start for macOS and Linux
...
```bash
npm install -g @gitlawb/neuron@latest
```

## 7. Uninstalling Neuron

```bash
npm uninstall -g @gitlawb/neuron
```
