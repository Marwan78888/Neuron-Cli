# Neuron for Non-Technical Users
...
Neuron lets you use an AI coding assistant with different model providers such as:
...
After you run `neuron`, the CLI should start and wait for your prompt.
