...
export const useSessionCommands = (actions: SessionCommandContext) => {
  ...
  const settingsCmds = () => [
    settingsCommand({
      id: "settings.searchProvider",
      title: language.t("command.settings.searchProvider"),
      description: language.t("command.settings.searchProvider.description"),
      slash: "search-provider",
      onSelect: () => {
        void import("@/components/dialog-settings").then((x) => {
          dialog.show(() => <x.DialogSettings initialTab="search" />)
        })
      },
    }),
  ]
