export const dict = {
  ...
  "command.settings.searchProvider": "Open search provider settings",
  "command.settings.searchProvider.description": "Choose Brave or Perplexity search and manage access",
  ...
  "settings.tab.searchProvider": "Search Provider",
  "settings.search.title": "Search Provider",
  "settings.search.description":
    "Choose the search backend Neuron should prefer, store the API key, and control full computer access for this workspace.",
  "settings.search.row.provider.title": "Preferred provider",
  "settings.search.row.provider.description":
    'Neuron will prefer this provider for search workflows and load the "agent-browser" skill when browsing is needed.',
  "settings.search.row.apiKey.title": "API key",
  "settings.search.row.apiKey.description": "Stored in this workspace config and used for your selected search provider.",
  "settings.search.row.apiKey.placeholder": "Paste API key",
  "settings.search.row.fullAccess.title": "Full computer access",
  "settings.search.row.fullAccess.description":
    "Turn this on to allow tools without permission prompts in this workspace. Turn it off to go back to ask mode.",
  "settings.search.agentBrowser.title": "Search Skill",
  "settings.search.agentBrowser.description":
    'Neuron keeps the "agent-browser" skill URL in this workspace so the agent can load it for web research flows.',
  "settings.search.saved": "Saved to workspace config.",
