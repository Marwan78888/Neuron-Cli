...
function createTempAuthJson(payload: Record<string, unknown>): string {
  const dir = mkdtempSync(join(tmpdir(), 'neuron-codex-'))
  tempDirs.push(dir)
        ...
        output: [
          {
            ...
            sources: [
              {
                title: 'Neuron repo',
                url: 'https://github.com/example/neuron',
              },
            ],
          },
          {
            ...
            content: [
              {
                type: 'text',
                text: 'Neuron is available on GitHub.',
                sources: [
                  {
                    title: 'Docs',
                    url: 'https://docs.example.com/neuron',
                  },
                ],
              },
            ],
            ...
            content: [
              {
                ...
                sources: [
                  { title: 'Docs', url: 'https://docs.example.com/neuron' },
                ],
              },
            ],
          },
