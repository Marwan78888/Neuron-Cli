...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Neuron now.</p>
    <p>Neuron will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Neuron.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Neuron.</p>
  </body>
</html>`
}
