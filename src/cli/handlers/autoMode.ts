...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Neuron.\n' +
  '\n' +
  'Neuron has an "auto mode" that uses an AI classifier to decide whether ' +
...
export async function autoModeCritiqueHandler(options: {
  ...
  if (!hasCustomRules) {
    process.stdout.write(
      ...
      'Run `neuron auto-mode defaults` to see the default rules for reference.\n',
    )
    return
  }
