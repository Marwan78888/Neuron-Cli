...
**All verifier skills are created in the project root's \`.neuron/skills/\` directory.** This ensures they are automatically loaded when Claude runs in the project.

Write the skill file to \`.neuron/skills/<verifier-name>/SKILL.md\`.
...
1. Where each skill was created (always in \`.neuron/skills/\`)
