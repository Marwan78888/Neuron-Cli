...
const DEFAULT_PREFIX =
  `You are Neuron, an interactive coding agent made by Marwan Reyad.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX =
  `You are Neuron, an interactive coding agent made by Marwan Reyad and running within the Agent SDK.`
const AGENT_SDK_PREFIX =
  `You are Neuron, built on the Agent SDK. Made by Marwan Reyad.`
