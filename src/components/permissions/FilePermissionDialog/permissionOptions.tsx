...
export function getFilePermissionOptions({
  ...
  if (yesInputMode && onAcceptFeedbackChange) {
    options.push({
      ...
      label: 'Yes',
      value: 'yes',
      placeholder: 'and tell Neuron what to do next',
  ...
  if ((inClaudeFolder || inGlobalClaudeFolder) && operationType !== 'read') {
    options.push({
      label: 'Yes, and allow Neuron to edit its own settings for this session',
  ...
  if (noInputMode && onRejectFeedbackChange) {
    options.push({
      ...
      label: 'No',
      value: 'no',
      placeholder: 'and tell Neuron what to do differently',
