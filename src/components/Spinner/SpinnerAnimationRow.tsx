...
// Neuron thinking color (golden-yellow)
...
export function SpinnerAnimationRow({
  ...
  return <FullWidthRow>
      <Box ref={viewportRef} flexDirection="row" flexWrap="wrap" marginTop={1}>
        <SpinnerGlyph frame={frame} messageColor={messageColor} stalledIntensity={overrideColor ? 0 : stalledIntensity} reducedMotion={reducedMotion} time={time} mode={mode} spinnerType={spinnerType} />
