 ...
 *
 * Usage:
 *   neuron --provider openai --model gpt-4o
 *   neuron --provider gemini --model gemini-2.0-flash
 *   neuron --provider mistral --model ministral-3b-latest
 *   neuron --provider ollama --model llama3.2
 *   neuron --provider anthropic   (default, no-op)
 */
