...
export const DESCRIPTION = 'Get or set Neuron configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Neuron configuration settings.

  View or change Neuron settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.neuron.json)
${globalSettings.join('\n')}
