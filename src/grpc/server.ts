...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/neuron.proto')
...
const neuronProto = protoDescriptor.neuron.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(neuronProto.AgentService.service, {
