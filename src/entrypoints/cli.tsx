...
// Neuron: polyfill globalThis.File for Node < 20.
...
// Neuron: disable experimental API betas by default.
...
async function main(): Promise<void> {
  ...
  if (args.length === 1 && (args[0] === '--version' || args[0] === '-v' || args[0] === '-V')) {
    ...
    console.log(`${MACRO.DISPLAY_VERSION ?? MACRO.VERSION} (Neuron)`);
    return;
  }
  ...
  if (process.env.NEURON_DISABLE_EARLY_INPUT !== '1') {
    const {
